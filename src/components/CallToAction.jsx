    ...
    <section id="planos" className="bg-[#0C0C0C] py-20 px-4">
      <div className="max-w-7xl mx-auto bg-brand-gold rounded-[3rem] md:rounded-[3.5rem] p-8 md:p-20 text-black relative overflow-hidden shadow-[0_0_100px_rgba(212,175,55,0.15)]">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12 md:gap-16 mb-16 text-center md:text-left">
          ...
          {/* Lado Esquerdo: Valores Atualizados */}
          <div className="flex-1 w-full">
            ...
            <h2 className="text-5xl md:text-8xl font-black leading-[0.85] tracking-tighter mb-8 italic uppercase">
              PLANO <br className="hidden md:block" /> ANUAL <br className="hidden md:block" /> <span className="opacity-70">BLACK</span>.
            </h2>
            <div className="text-5xl md:text-7xl font-black italic mb-2 tracking-tighter">12x R$ 239</div>
            {/* Referência ao Mensal Recorrente como comparativo de 'sem contrato' */}
            <p className="pl-6 pt-2 text-2xl font-bold opacity-60 italic text-black/80">ou R$ 269/mês no recorrente</p>
          </div>

          {/* Lado Direito: Benefícios e Cálculo Diário */}
          <div className="flex-1 w-full">
            ...
            {/* R$ 239 / 30 dias = ~R$ 7,96 */}
            <h1 className="text-4xl md:text-4xl font-black leading-[0.85] tracking-tighter italic">
              = R$ 7,90 por dia
            </h1>
            <p className="pt-4 font-bold text-md opacity-80 uppercase tracking-tighter">O investimento no seu corpo custa menos que um lanche.</p>
          </div>
        </div>
