  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl bg-gray-900/50 border border-white/5 rounded-[3rem] p-8 md:p-12 shadow-2xl text-white relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-64 h-64 bg-brand-gold/10 rounded-full blur-[100px]"></div>

        <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-brand-gold rounded-full mb-6 shadow-[0_0_40px_rgba(177,248,42,0.3)]">
                <CheckCircle size={40} className="text-black" />
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter italic uppercase leading-none">
                TUDO PRONTO, <br />
                <span className="text-brand-gold">{nomeUsuario}!</span>
            </h2>
        ...
        >
          <motion.div variants={itemVariants} className="bg-white/5 p-8 rounded-[2.5rem] border border-white/10 flex flex-col justify-center">
            <h3 className="text-xl font-black text-brand-gold mb-6 flex items-center gap-2 uppercase italic tracking-tighter">
          ...
          <motion.div variants={itemVariants} className="bg-brand-gold p-8 rounded-[2.5rem] text-black">
            ...
            <ul className="space-y-4 font-black uppercase text-[11px] italic leading-tight">
              <li className="flex items-start gap-3">
                <div className="bg-black text-brand-gold w-5 h-5 flex items-center justify-center rounded-full flex-shrink-0 text-[10px]">1</div>
                Confirmaremos seu horário via WhatsApp.
              </li>
              <li className="flex items-start gap-3">
                <div className="bg-black text-brand-gold w-5 h-5 flex items-center justify-center rounded-full flex-shrink-0 text-[10px]">2</div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center gap-6">
          <Button
            ...
            className="w-full md:w-auto px-12 py-10 text-2xl font-black rounded-3xl bg-brand-gold text-black hover:bg-white hover:scale-105 transition-all duration-300 shadow-[0_0_40px_rgba(177,248,42,0.2)] uppercase italic tracking-tighter"
          >
